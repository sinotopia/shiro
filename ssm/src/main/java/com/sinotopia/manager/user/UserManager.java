package com.sinotopia.manager.user;
...
import com.sinotopia.common.utils.MathUtil;
...
public class UserManager {
     ...
     * @return
     */
    public static IdentityUser md5Pswd(IdentityUser user) {
