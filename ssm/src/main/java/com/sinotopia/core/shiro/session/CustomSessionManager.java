package com.sinotopia.core.shiro.session;
...
import com.sinotopia.core.shiro.CustomShiroSessionDAO;
import com.sinotopia.dto.user.UserOnlineBo;
...
public class CustomSessionManager {
    ...
    public List<SimplePrincipalCollection> getSimplePrincipalCollectionByUserId(Long... userIds) {
        ...
        for (Session session : sessions) {
            ...
            if (null != obj && obj instanceof SimplePrincipalCollection) {
                ...
                if (null != obj && obj instanceof IdentityUser) {
                    IdentityUser user = (IdentityUser) obj;
                    //比较用户ID，符合即加入集合
    ...
    private UserOnlineBo getSessionBo(Session session) {
        ...
        if (obj instanceof SimplePrincipalCollection) {
            ...
            if (null != obj && obj instanceof IdentityUser) {
                //存储session + user 综合信息
                UserOnlineBo userBo = new UserOnlineBo((IdentityUser) obj);
                //最后一次和系统交互的时间
