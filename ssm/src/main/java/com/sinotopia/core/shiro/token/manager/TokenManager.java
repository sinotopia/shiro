package com.sinotopia.core.shiro.token.manager;
...
public class TokenManager {
     ...
     * @return
     */
    public static IdentityUser getToken() {
        IdentityUser token = (IdentityUser) SecurityUtils.getSubject().getPrincipal();
        return token;
    }
     ...
     * @return
     */
    public static IdentityUser login(IdentityUser user, Boolean rememberMe) {
