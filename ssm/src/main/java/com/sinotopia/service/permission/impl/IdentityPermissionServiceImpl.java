package com.sinotopia.service.permission.impl;
...
import com.sinotopia.common.dao.IdentityPermissionMapper;
import com.sinotopia.common.dao.IdentityRolePermissionMapper;
import com.sinotopia.common.dao.IdentityUserMapper;
import com.sinotopia.common.dao.IdentityUserRoleMapper;
...
public class IdentityPermissionServiceImpl extends BaseMybatisDao<IdentityPermissionMapper> implements IdentityPermissionService {
    ...
    @Override
    public IdentityPermission insert(IdentityPermission record) {
        permissionMapper.insert(record);
        return record;
    }

    @Override
    public IdentityPermission insertSelective(IdentityPermission record) {
        //添加权限
    ...
    @Override
    public IdentityPermission selectByPrimaryKey(Long id) {
        return permissionMapper.selectByPrimaryKey(id);
    }

    @Override
    public int updateByPrimaryKey(IdentityPermission record) {
        return permissionMapper.updateByPrimaryKey(record);
    }

    @Override
    public int updateByPrimaryKeySelective(IdentityPermission record) {
    ...
    public Map<String, Object> deletePermissionById(String ids) {
        ...
        try {
            ...
            for (String idx : idArray) {
                ...
                List<IdentityRolePermission> rolePermissions = rolePermissionMapper.findRolePermissionByPid(id);
    ...
    @Override
    public Pagination<IdentityPermission> findPage(Map<String, Object> resultMap, Integer pageNo,
                                                   Integer pageSize) {
            ...
            if (StringUtils.isNotBlank(ids)) {
                ...
                for (String pid : idArray) {
                    ...
                    if (StringUtils.isNotBlank(pid)) {
                        IdentityRolePermission entity = new IdentityRolePermission(roleId, new Long(pid));
