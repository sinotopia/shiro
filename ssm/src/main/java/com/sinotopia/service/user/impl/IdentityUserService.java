package com.sinotopia.service.user.impl;
...
public class IdentityUserService extends BaseMybatisDao<IdentityUserMapper> implements IdentityUserService {
    ...
    @Override
    public IdentityUser insert(IdentityUser entity) {
        userMapper.insert(entity);
        return entity;
    }

    @Override
    public IdentityUser insertSelective(IdentityUser entity) {
        userMapper.insertSelective(entity);
        return entity;
    }

    @Override
    public IdentityUser selectByPrimaryKey(Long id) {
        return userMapper.selectByPrimaryKey(id);
    }

    @Override
    public int updateByPrimaryKey(IdentityUser entity) {
        return userMapper.updateByPrimaryKey(entity);
    }

    @Override
    public int updateByPrimaryKeySelective(IdentityUser entity) {
        return userMapper.updateByPrimaryKeySelective(entity);
    }

    @Override
    public IdentityUser login(String email, String pswd) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("email", email);
        map.put("pswd", pswd);
        IdentityUser user = userMapper.login(map);
        return user;
    }
    ...
    @Override
    public Pagination<IdentityUser> findByPage(Map<String, Object> resultMap,
    ...
    public Map<String, Object> updateForbidUserById(Long id, Long status) {
        Map<String, Object> resultMap = new HashMap<String, Object>();
        try {
            IdentityUser user = selectByPrimaryKey(id);
            ...
            if (StringUtils.isNotBlank(ids)) {
                ...
                for (String rid : idArray) {
                    ...
                    if (StringUtils.isNotBlank(rid)) {
                        IdentityUserRole entity = new IdentityUserRole(userId, new Long(rid));
