package com.sinotopia.controller.user;
...
import com.sinotopia.common.utils.VerifyCodeUtils;
...
public class UserLoginController extends BaseController {
	...
	@ResponseBody
	public Map<String,Object> subRegister(String vcode,IdentityUser entity){
		...
		IdentityUser user = userService.findUserByEmail(email);
		if(null != user){
		...
		//设置有效
		entity.setStatus(IdentityUser._1);
	...
	@ResponseBody
	public Map<String,Object> submitLogin(IdentityUser entity, Boolean rememberMe, HttpServletRequest request){
