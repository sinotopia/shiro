...
public class RoleController extends BaseController {
	...
	public ModelAndView index(String findContent,ModelMap modelMap){
		...
		Pagination<IdentityRole> role = roleService.findPage(modelMap,pageNo,pageSize);
	...
	@ResponseBody
	public Map<String,Object> addRole(IdentityRole role){
		try {
	...
	public List<Map<String, Object>> getPermissionTree(){
		//查询我所有的角色 ---> 权限
		List<IdentityRole> roles = roleService.findNowAllPermission();
