...
import com.sinotopia.service.permission.impl.IdentityPermissionServiceImpl;
...
public class PermissionController extends BaseController {
    ...
    @Autowired
    private IdentityPermissionServiceImpl permissionService;
    ...
    public ModelAndView index(String findContent, ModelMap modelMap, Integer pageNo) {
        ...
        Pagination<IdentityPermission> permissions = permissionService.findPage(modelMap, pageNo, pageSize);
    ...
    @ResponseBody
    public Map<String, Object> addPermission(IdentityPermission psermission) {
        try {
            IdentityPermission entity = permissionService.insertSelective(psermission);
