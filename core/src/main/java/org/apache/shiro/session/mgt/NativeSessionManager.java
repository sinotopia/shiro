...
public interface NativeSessionManager extends SessionManager {
     ...
     *
     * @param key the session key to use to look up the target session.
     * @throws org.apache.shiro.session.InvalidSessionException if the session id is invalid (it does not exist or it is stopped or expired).
     */
     ...
     * @throws org.apache.shiro.session.InvalidSessionException if the session has been stopped or expired prior to calling this method.
     */
